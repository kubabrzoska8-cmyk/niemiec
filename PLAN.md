...
## Dlaczego kolejność jest odwrócona względem typowego kursu B1

Standardowy program B1 idzie: czasy → szyk zdania → tryby → przypadki „przy okazji".
**Tutaj przypadki idą pierwsze i zajmują cały blok 1.**

Powód jest w danych, nie w metodyce. Cztery pierwsze sesje pokazały ucznia, który **buduje
poprawne zdania podrzędne** (`weil`, `obwohl` — sześć z rzędu bez podpowiedzi), a jednocześnie
mówi `mit einen kalten bier` i `meine Gehirn`. Uczenie go szyku zdania byłoby ćwiczeniem tego,
co już umie. Wąskie gardło siedzi **wewnątrz grupy rzeczownikowej**, więc tam zaczynamy.

---

## Przegląd

| Blok | Sesje | Temat | Plik |
|------|-------|-------|------|
| — | 1–4 | *(przed strukturą — swobodne rozmowy, zapis w `/drafts`)* | — |
| **1** | 5–11 | **Kasus i grupa rzeczownikowa** | [`plan/block-1.md`](plan/block-1.md) |
| **2** | 12–17 | **Satzbau — zdanie złożone i szyk** | [`plan/block-2.md`](plan/block-2.md) |
| **3** | 18–24 | **Czasy i tryby** | [`plan/block-3.md`](plan/block-3.md) |
| **4** | 25–30 | **Fachsprache, płynność i test B2** | [`plan/block-4.md`](plan/block-4.md) |

Misje: [`plan/missions.md`](plan/missions.md) · Źródła inputu: [`resources/RESOURCES.md`](resources/RESOURCES.md)

---

## Tabela 30 sesji

| # | Temat | Gramatyka | Luka celowana | Misja (typ) |
|---|-------|-----------|---------------|-------------|
| 1 | Alltag nach der Uni | — | — | *(przed strukturą)* |
| 2 | Prüfungsstress und Studienalltag | — | `studieren`/`lernen` | *(przed strukturą)* |
