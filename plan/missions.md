...
Cel: zdania złożone, których nie budujesz jeszcze odruchowo — `dass`, `ob`, `nachdem`, względne.

| Sesja | Misja | Wymuszona konstrukcja | Zaliczone, gdy |
|-------|-------|----------------------|----------------|
| 12 | 🎧 **Ohrwurm — polowanie na spójniki.** Wypisz 6 zdań podrzędnych | `dass, ob, wenn, als, während` | Przy każdym zdaniu podkreślony czasownik na końcu |
| 13 | ✍️ **Pięć rzeczy, których nie wiesz** o swoich studiach / przyszłości | `Ich weiß nicht, ob…` | 5 zdań, żadne bez `ob`/`dass` |
| 14 | 🎤 **60 s: wczorajszy dzień co do godziny** | `TeKaMoLo` — kolejność okoliczników | Nagranie + zapis: sprawdzimy kolejność |
| 15 | 🎧 **Ohrwurm — `um…zu` na słuch.** Wypisz 4 zdania celowe | `um…zu`, `ohne…zu` | 4 zdania, przy każdym cel wypisany po polsku |
| 16 | ✍️ **Opisz 5 osób z Twojego roku** zdaniami względnymi | `der/die/das`, `mit dem`, `dessen` | 5 zdań względnych, min. 2 z przyimkiem |
| 17 | 🎯 🎤 **3 minuty o studiach.** Bez notatek, bez pauzy na przygotowanie | min. 5 zdań podrzędnych | Nagranie 3 min bez przejścia na polski |

---

## Blok 3 — Czasy i tryby *(sesje 18–24)*

Cel: opowiadać o przeszłości i o rzeczach nierzeczywistych.
...
## Blok 4 — Fachsprache i płynność *(sesje 25–30)*

Cel: mówić po niemiecku o tym, co i tak robisz po polsku.
...
| 29 | ✍️ **Obroń tezę:** „Medizinstudium sollte kürzer sein" — za i przeciw | `einerseits… andererseits`, `dennoch` | 10 zdań, min. 6 zwrotów argumentacyjnych |
| 30 | 🏁 **Bez misji.** Sesja 30 to test | — | — |
